...
//     try {
//         const rexpayClient = new RexPayClient('test'); // Use 'live' for production
        
//         const transactionId = `REX${Date.now()}${Math.floor(Math.random() * 1000)}`;
        
//         // Complete payment data with all required fields
//         const paymentData = {
//             reference: transactionId,
...
//             userId: checkoutData.customerEmail || 'customer@example.com',
//             callbackUrl: `${window.location.origin}/checkout?status=rexpay_callback`,
//             clientId: process.env.NEXT_PUBLIC_REXPAY_CLIENT_ID || 'sheriffazeez333gmailcom', // Your client ID
//             metadata: {
//                 email: checkoutData.customerEmail || '',
//                 customerName: checkoutData.customerName || 'Customer',
//                 orderNo: checkoutData.orderNo,
//                 storeCode: checkoutData.storeCode,
//             },
//             paymentChannel: 'DEFAULT', // or 'CARD', 'USSD', 'ACCOUNT' based on preference
//             country: 'NGA', // Nigeria
//             feeBearer: 'Merchant', // or 'Customer'
