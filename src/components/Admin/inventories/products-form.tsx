      ...
      <form onSubmit={handleSubmit(onSubmitForm)} className="space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <Card className="border-accent/50 border-4 shadow-sm">
            <CardHeader className="bg-accent/15 pb-3">
              <CardTitle className="text-lg flex items-center gap-2">
                <Barcode className="h-5 w-5 text-accent-foreground" />
                Codes & IDs
              </CardTitle>
            ...
            <CardContent className="p-6 space-y-4">
              <div className="space-y-2">
                <Label htmlFor="productCode" className="flex items-center gap-1">
          ...
          <Card className="border-accent/50 border-4 shadow-sm">
            ...
            <CardContent className="p-6 space-y-4">
              <div className="space-y-2">
                <Label htmlFor="stockQuantity" className="flex items-center gap-1">
